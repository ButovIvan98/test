...
const InputSelectContainerExport = connect(mapStateToProps,{UpdateStatusTrue,UpdateStatusFalse,updateTextCountry,updateTextCity,updateTextStreet,updateTextHouse,updateTextFlat,updateTextIndex})(InputText);

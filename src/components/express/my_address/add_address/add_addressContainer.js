...
const AddressContainerExport = connect(mapStateToProps,{updateTextCountry, updateTextCity,updateTextStreet,updateTextHouse, updateTextFlat,updateTextIndex})(AddressForm);
